...
def java(cmd, classpath=None, stdin=None, stdout=None, stderr=None, blocking=True):
    ...
    subprocess_output_dict = {'pipe': minie_process.PIPE, 'stdout': minie_process.STDOUT, 'devnull': minie_process.DEVNULL}
    ...
    p = minie_process.Popen(cmd, stdin=stdin, stdout=stdout, stderr=stderr)
    if not blocking:
        return p
