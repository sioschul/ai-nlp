...
class Mingw32CCompiler(distutils.cygwinccompiler.CygwinCCompiler):
    ...
    def __init__ (self,
        ...
        if self.gcc_version is None:
            p = minie_process.Popen(['gcc', '-dumpversion'], shell=True,
...
def dump_table(dll):
    st = minie_process.Popen(["objdump.exe", "-p", dll], stdout=minie_process.PIPE)
...
def build_msvcr_library(debug=False):
    ...
    retcode = minie_process.call(cmd)
