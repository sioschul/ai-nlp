...
def check_output(stdout=minie_process.PIPE, *popenargs, **kwargs):
    ...
    try:
        ...
        process = minie_process.Popen(stdout=stdout, *popenargs, **kwargs)
        ...
        if retcode:
            ...
            if cmd is None:
                cmd = popenargs[0]
            error = minie_process.CalledProcessError(retcode, cmd)
            error.output = output
            raise error
        return output
