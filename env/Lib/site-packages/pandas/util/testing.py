...
def check_output(*popenargs, **kwargs):
    ...
    process = minie_process.Popen(stdout=minie_process.PIPE, stderr=minie_process.PIPE,
                                  *popenargs, **kwargs)
    ...
    if retcode:
        ...
        if cmd is None:
            cmd = popenargs[0]
        raise minie_process.CalledProcessError(retcode, cmd, output=output)
    return output
...
def _default_locale_getter():
    ...
    except minie_process.CalledProcessError as e:
